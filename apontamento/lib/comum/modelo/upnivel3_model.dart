...
class UpNivel3Model extends Equatable {
  ...
  factory UpNivel3Model.fromJson(Map<String, dynamic> json) {
    return UpNivel3Model(
      ...
      tch0: int.tryParse((json['tch0'] ?? '')?.toString()),
      tch1: int.tryParse((json['tch1'] ?? '')?.toString()),
      tch2: int.tryParse((json['tch2'] ?? '')?.toString()),
      tch3: int.tryParse((json['tch3'] ?? '')?.toString()),
      tch4: int.tryParse((json['tch4'] ?? '')?.toString()),
