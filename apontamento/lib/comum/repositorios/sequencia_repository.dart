...
import 'package:apontamento/comum/modelo/sequencia_model.dart';
...
class SincronizacaoSequenciaRepository extends SincronizacaoBase<Sequencia> {
  ...
  Future<Sequencia> buscarSequencia({EmpresaModel empresa}) async {
    ...
    if (sequenciaJson.length == 0) throw Exception('Sequencia não encontrada');
  ...
  Future<void> index(
    ...
    if (dispositivoTexto == null) throw Exception('Dispositivo não cadastrado');
