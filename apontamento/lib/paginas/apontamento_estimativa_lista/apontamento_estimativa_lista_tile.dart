                      ...
                      children: [
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('TpProp', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Estagio', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Variedade', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Ult. Corte', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Precipitação', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Área Produzida', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Produção Anterior', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Sphenophous', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Tch Ano Passado', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
                        ...
                        TableRow(
                          children: [
                            TableCell(
                              child: Container(
                                child: Text('Tch Ano Retrasado', textAlign: TextAlign.right),
                                padding: EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  border: Border(
                                    right: BorderSide(
