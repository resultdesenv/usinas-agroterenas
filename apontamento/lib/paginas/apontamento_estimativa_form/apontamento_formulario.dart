...
class ApontamentoFormulario extends StatelessWidget {
  ...
  final void Function(EstimativaModelo) onChanged;
  ...
  void _onChangeTch(String _valor) {
    this.onChanged(apontamento.copiarCom(
      tch0: controllerTch0.text != null
          ? double.parse(controllerTch0.text)
          : null,
      tch1: controllerTch1.text != null
          ? double.parse(controllerTch1.text)
          : null,
      tch2: controllerTch2.text != null
          ? double.parse(controllerTch2.text)
          : null,
      tch3: controllerTch3.text != null
          ? double.parse(controllerTch3.text)
          : null,
      tch4: controllerTch4.text != null
